...
public class BlockDoor extends Block
{
    ...
    {
        setBoundBasedOnMeta(BlockDoor.combineMetadata(worldIn, pos));
    }
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float hitX, float hitY, float hitZ)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                worldIn.playAuxSFXAtEntity(playerIn, state.getValue(BlockDoor.OPEN).booleanValue() ? 1003 : 1006, pos, 0);
                return true;
            }
        }
    }
    ...
    public void toggleDoor(World worldIn, BlockPos pos, boolean open)
    {
        ...
        if (iblockstate.getBlock() == this)
        {
            ...
            {
                worldIn.setBlockState(blockpos, iblockstate1.withProperty(BlockDoor.OPEN, Boolean.valueOf(open)), 2);
                worldIn.markBlockRangeForRenderUpdate(blockpos, pos);
    ...
    public void onNeighborBlockChange(World worldIn, BlockPos pos, IBlockState state, Block neighborBlock)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                if ((flag || neighborBlock.canProvidePower()) && neighborBlock != this && flag != iblockstate1.getValue(BlockDoor.POWERED).booleanValue())
                {
                    worldIn.setBlockState(blockpos1, iblockstate1.withProperty(BlockDoor.POWERED, Boolean.valueOf(flag)), 2);

                    if (flag != state.getValue(BlockDoor.OPEN).booleanValue())
                    {
    ...
    {
        return state.getValue(BlockDoor.HALF) == BlockDoor.EnumDoorHalf.UPPER ? null : getItem();
    }
    ...
    {
        return (meta & 8) > 0 ? getDefaultState().withProperty(BlockDoor.HALF, BlockDoor.EnumDoorHalf.UPPER).withProperty(BlockDoor.HINGE, (meta & 1) > 0 ? BlockDoor.EnumHingePosition.RIGHT : BlockDoor.EnumHingePosition.LEFT).withProperty(BlockDoor.POWERED, Boolean.valueOf((meta & 2) > 0)) : getDefaultState().withProperty(BlockDoor.HALF, BlockDoor.EnumDoorHalf.LOWER).withProperty(BlockDoor.FACING, EnumFacing.getHorizontal(meta & 3).rotateYCCW()).withProperty(BlockDoor.OPEN, Boolean.valueOf((meta & 4) > 0));
    }
    ...
    public int getMetaFromState(IBlockState state)
    {
        ...
        if (state.getValue(BlockDoor.HALF) == BlockDoor.EnumDoorHalf.UPPER)
        {
            ...
            if (state.getValue(BlockDoor.POWERED).booleanValue())
            {
                i |= 2;
            }
        }
    ...
    {
        return new BlockState(this, BlockDoor.HALF, BlockDoor.FACING, BlockDoor.OPEN, BlockDoor.HINGE, BlockDoor.POWERED);
    }
