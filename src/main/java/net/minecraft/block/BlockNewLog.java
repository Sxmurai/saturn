...
public class BlockNewLog extends BlockLog
{
    ...
    public BlockNewLog()
    {
        setDefaultState(blockState.getBaseState().withProperty(BlockNewLog.VARIANT, BlockPlanks.EnumType.ACACIA).withProperty(BlockLog.LOG_AXIS, BlockLog.EnumAxis.Y));
    }
    ...
    {
        BlockPlanks.EnumType blockplanks$enumtype = state.getValue(BlockNewLog.VARIANT);
    ...
    {
        IBlockState iblockstate = getDefaultState().withProperty(BlockNewLog.VARIANT, BlockPlanks.EnumType.byMetadata((meta & 3) + 4));
    ...
    {
        int i = 0;
        i = i | state.getValue(BlockNewLog.VARIANT).getMetadata() - 4;
    ...
    {
        return new BlockState(this, BlockNewLog.VARIANT, BlockLog.LOG_AXIS);
    }
