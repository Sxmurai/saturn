...
public class BlockPistonExtension extends Block
{
    ...
    public BlockPistonExtension()
    {
        ...
        setDefaultState(blockState.getBaseState().withProperty(BlockPistonExtension.FACING, EnumFacing.NORTH).withProperty(BlockPistonExtension.TYPE, BlockPistonExtension.EnumPistonType.DEFAULT).withProperty(BlockPistonExtension.SHORT, Boolean.valueOf(false)));
    ...
    public void onBlockHarvested(World worldIn, BlockPos pos, IBlockState state, EntityPlayer player)
    {
        ...
        {
            EnumFacing enumfacing = state.getValue(BlockPistonExtension.FACING);
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        EnumFacing enumfacing = state.getValue(BlockPistonExtension.FACING).getOpposite();
    ...
    private void applyCoreBounds(IBlockState state)
    {
        ...
        switch (state.getValue(BlockPistonExtension.FACING))
        {
            case DOWN:
    ...
    {
        return worldIn.getBlockState(pos).getValue(BlockPistonExtension.TYPE) == BlockPistonExtension.EnumPistonType.STICKY ? Item.getItemFromBlock(Blocks.sticky_piston) : Item.getItemFromBlock(Blocks.piston);
    }
    ...
    {
        return getDefaultState().withProperty(BlockPistonExtension.FACING, BlockPistonExtension.getFacing(meta)).withProperty(BlockPistonExtension.TYPE, (meta & 8) > 0 ? BlockPistonExtension.EnumPistonType.STICKY : BlockPistonExtension.EnumPistonType.DEFAULT);
    }
    ...
    {
        int i = 0;
        i = i | state.getValue(BlockPistonExtension.FACING).getIndex();

        if (state.getValue(BlockPistonExtension.TYPE) == BlockPistonExtension.EnumPistonType.STICKY)
        {
            i |= 8;
        }
    ...
    {
        return new BlockState(this, BlockPistonExtension.FACING, BlockPistonExtension.TYPE, BlockPistonExtension.SHORT);
    }
