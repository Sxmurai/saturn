...
public class SoundManager
{
    ...
    public boolean isSoundPlaying(ISound sound)
    {
        ...
        else
        {
            ...
            return s != null && (sndSystem.playing(s) || playingSoundsStopTime.containsKey(s) && playingSoundsStopTime.get(s).intValue() <= playTime);
        }
    }
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                sndSystem.newStreamingSource(false, s, SoundManager.getURLForSoundResource(resourcelocation), resourcelocation.toString(), flag, sound.getXPosF(), sound.getYPosF(), sound.getZPosF(), sound.getAttenuationType().getTypeInt(), f1);
                            }
                            else
                            {
                                sndSystem.newSource(false, s, SoundManager.getURLForSoundResource(resourcelocation), resourcelocation.toString(), flag, sound.getXPosF(), sound.getYPosF(), sound.getZPosF(), sound.getAttenuationType().getTypeInt(), f1);
                            }
