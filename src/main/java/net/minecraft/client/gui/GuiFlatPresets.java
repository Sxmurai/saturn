...
public class GuiFlatPresets extends GuiScreen
{
    ...
    {
        return field_146435_s.field_148175_k > -1 && field_146435_s.field_148175_k < GuiFlatPresets.FLAT_WORLD_PRESETS.size() || field_146433_u.getText().length() > 1;
    }
    ...
    private static void func_175354_a(String p_175354_0_, Item p_175354_1_, int p_175354_2_, BiomeGenBase p_175354_3_, List<String> p_175354_4_, FlatLayerInfo... p_175354_5_)
    {
        ...
        GuiFlatPresets.FLAT_WORLD_PRESETS.add(new GuiFlatPresets.LayerItem(p_175354_1_, p_175354_2_, p_175354_0_, flatgeneratorinfo.toString()));
    }
