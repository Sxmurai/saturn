...
public class GuiIngame extends Gui
{
    ...
    public void renderDemo(ScaledResolution p_175185_1_)
    {
        ...
        {
            s = I18n.format("demo.remainingTime", StringUtils.ticksToElapsedTime((int)(120500L - mc.theWorld.getTotalWorldTime())));
        }

        int i = getFontRenderer().getStringWidth(s);
        getFontRenderer().drawStringWithShadow(s, (float)(p_175185_1_.getScaledWidth() - i - 10), 5.0F, 16777215);
        mc.mcProfiler.endSection();
    }
    ...
    private void renderScoreboard(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_)
    {
        ...
        for (Object score1 : arraylist1)
        {
            ...
            if (k == arraylist1.size())
            {
                ...
                Gui.drawRect(j - 2, l - getFontRenderer().FONT_HEIGHT - 1, i1, l - 1, 1610612736);
    ...
    private void renderPumpkinOverlay(ScaledResolution p_180476_1_)
    {
        ...
        GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
        GlStateManager.disableAlpha();
        mc.getTextureManager().bindTexture(GuiIngame.pumpkinBlurTexPath);
