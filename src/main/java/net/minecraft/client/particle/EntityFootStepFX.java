...
public class EntityFootStepFX extends EntityFX
{
    ...
    public void renderParticle(WorldRenderer worldRendererIn, Entity entityIn, float partialTicks, float p_180434_4_, float p_180434_5_, float p_180434_6_, float p_180434_7_, float p_180434_8_)
    {
        ...
        float f2 = 0.125F;
        float f3 = (float)(posX - EntityFX.interpPosX);
        float f4 = (float)(posY - EntityFX.interpPosY);
        float f5 = (float)(posZ - EntityFX.interpPosZ);
        float f6 = worldObj.getLightBrightness(new BlockPos(this));
        currentFootSteps.bindTexture(EntityFootStepFX.FOOTPRINT_TEXTURE);
