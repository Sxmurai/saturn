...
public class RenderManager
{
    ...
    public RenderManager(TextureManager renderEngineIn, RenderItem itemRendererIn)
    {
        ...
        {
            Reflector.call(Reflector.RenderingRegistry_loadEntityRenderers, entityRenderMap);
        }
    }
    ...
    public Render getEntityRenderObject(Entity entityIn)
    {
        if (entityIn instanceof AbstractClientPlayer)
        {
            ...
            RenderPlayer renderplayer = (RenderPlayer) skinMap.get(s);
    ...
    {
        Render render = getEntityRenderObject(entityIn);
    ...
    {
        return Collections.<String, RenderPlayer>unmodifiableMap(skinMap);
    }
}
