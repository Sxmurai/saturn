...
public abstract class ResourcePackListEntry implements GuiListExtended.IGuiListEntry
{
    ...
    public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected)
    {
        ...
        {
            mc.getTextureManager().bindTexture(ResourcePackListEntry.RESOURCE_PACKS_TEXTURE);
            ...
            if (i < 1)
            {
                ...
                s1 = ResourcePackListEntry.field_183021_e.getFormattedText();
            }
            else if (i > 1)
            {
                s = ResourcePackListEntry.field_183020_d.getFormattedText();
                s1 = ResourcePackListEntry.field_183022_f.getFormattedText();
            }
