...
public class CommandGameMode extends CommandBase
{
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException
    {
        ...
        else
        {
            ...
            EntityPlayer entityplayer = args.length >= 2 ? CommandBase.getPlayer(sender, args[1]) : CommandBase.getCommandSenderAsPlayer(sender);
    ...
    {
        return args.length == 1 ? CommandBase.getListOfStringsMatchingLastWord(args, "survival", "creative", "adventure", "spectator"): (args.length == 2 ? CommandBase.getListOfStringsMatchingLastWord(args, getListOfPlayerUsernames()) : null);
    }
