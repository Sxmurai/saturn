...
public class CommandStats extends CommandBase
{
        ...
        else
        {
            ...
            else
            {
                ...
                if ("set".equals(s))
                {
                    ...
                    CommandBase.notifyOperators(sender, this, "commands.stats.success", commandresultstats$type.getTypeName(), s2, s1);
                }
    ...
    {
        return args.length == 1 ? CommandBase.getListOfStringsMatchingLastWord(args, "entity", "block"): (args.length == 2 && args[0].equals("entity") ? CommandBase.getListOfStringsMatchingLastWord(args, func_175776_d()) : (args.length >= 2 && args.length <= 4 && args[0].equals("block") ? CommandBase.func_175771_a(args, 1, pos) : ((args.length != 3 || !args[0].equals("entity")) && (args.length != 5 || !args[0].equals("block")) ? ((args.length != 4 || !args[0].equals("entity")) && (args.length != 6 || !args[0].equals("block")) ? ((args.length != 6 || !args[0].equals("entity")) && (args.length != 8 || !args[0].equals("block")) ? null : CommandBase.getListOfStringsMatchingLastWord(args, func_175777_e())) : CommandBase.getListOfStringsMatchingLastWord(args, CommandResultStats.Type.getTypeNames())) : CommandBase.getListOfStringsMatchingLastWord(args, "set", "clear"))));
    }
