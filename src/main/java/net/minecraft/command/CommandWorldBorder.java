        ...
        else
        {
            ...
            if (args[0].equals("set"))
            {
                ...
                if (i > 0L)
                {
                    ...
                    if (d0 > d2)
                    {
                        CommandBase.notifyOperators(sender, this, "commands.worldborder.setSlowly.shrink.success", String.format("%.1f", Double.valueOf(d2)), String.format("%.1f", Double.valueOf(d0)), Long.toString(i / 1000L));
                    }
                    else
                    {
                        CommandBase.notifyOperators(sender, this, "commands.worldborder.setSlowly.grow.success", String.format("%.1f", Double.valueOf(d2)), String.format("%.1f", Double.valueOf(d0)), Long.toString(i / 1000L));
                    }
                }
                else
                {
                    worldborder.setTransition(d2);
                    CommandBase.notifyOperators(sender, this, "commands.worldborder.set.success", String.format("%.1f", Double.valueOf(d2)), String.format("%.1f", Double.valueOf(d0)));
                }
            }
            else if (args[0].equals("add"))
            {
                ...
                long i1 = worldborder.getTimeUntilTarget() + (args.length > 2 ? CommandBase.parseLong(args[2], 0L, 9223372036854775L) * 1000L : 0L);
                ...
                if (i1 > 0L)
                {
                    ...
                    if (d4 > d8)
                    {
                        CommandBase.notifyOperators(sender, this, "commands.worldborder.setSlowly.shrink.success", String.format("%.1f", Double.valueOf(d8)), String.format("%.1f", Double.valueOf(d4)), Long.toString(i1 / 1000L));
                    }
                    else
                    {
                        CommandBase.notifyOperators(sender, this, "commands.worldborder.setSlowly.grow.success", String.format("%.1f", Double.valueOf(d8)), String.format("%.1f", Double.valueOf(d4)), Long.toString(i1 / 1000L));
                    }
                }
                else
                {
                    worldborder.setTransition(d8);
                    CommandBase.notifyOperators(sender, this, "commands.worldborder.set.success", String.format("%.1f", Double.valueOf(d8)), String.format("%.1f", Double.valueOf(d4)));
                }
            }
            else if (args[0].equals("center"))
            {
                ...
                CommandBase.notifyOperators(sender, this, "commands.worldborder.center.success", Double.valueOf(d1), Double.valueOf(d3));
            }
            else if (args[0].equals("damage"))
            {
                ...
                if (args[1].equals("buffer"))
                {
                    ...
                    CommandBase.notifyOperators(sender, this, "commands.worldborder.damage.buffer.success", String.format("%.1f", Double.valueOf(d5)), String.format("%.1f", Double.valueOf(d9)));
                }
                else if (args[1].equals("amount"))
                {
                    ...
                    CommandBase.notifyOperators(sender, this, "commands.worldborder.damage.amount.success", String.format("%.2f", Double.valueOf(d6)), String.format("%.2f", Double.valueOf(d10)));
                }
            }
            else if (args[0].equals("warning"))
            {
                ...
                if (args[1].equals("time"))
                {
                    ...
                    CommandBase.notifyOperators(sender, this, "commands.worldborder.warning.time.success", Integer.valueOf(j), Integer.valueOf(k));
                }
                else if (args[1].equals("distance"))
                {
                    ...
                    CommandBase.notifyOperators(sender, this, "commands.worldborder.warning.distance.success", Integer.valueOf(j), Integer.valueOf(l));
                }
            }
            else
            {
