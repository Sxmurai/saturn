...
public class PlayerSelector
{
    ...
    {
        Matcher matcher = PlayerSelector.tokenPattern.matcher(token);
    ...
    {
        for (String s : PlayerSelector.WORLD_BINDING_ARGS)
        {
    ...
    {
        Matcher matcher = PlayerSelector.tokenPattern.matcher(p_82377_0_);
    ...
    private static Map<String, String> getArgumentMap(String argumentString)
    {
        ...
        else
        {
            ...
            for (Matcher matcher = PlayerSelector.intListPattern.matcher(argumentString); matcher.find(); j = matcher.end())
            {
                String s = null;
            ...
            {
                Matcher matcher1 = PlayerSelector.keyValueListPattern.matcher(j == -1 ? argumentString : argumentString.substring(j));
