...
public class CommandScoreboard extends CommandBase
{
    ...
    protected void addObjective(ICommandSender sender, String[] args, int index) throws CommandException
    {
        ...
        else
        {
            ...
            {
                String s2 = CommandBase.getChatComponentFromNthArg(sender, args, index).getUnformattedText();
    ...
    protected void addTeam(ICommandSender sender, String[] args, int index) throws CommandException
    {
        ...
        else
        {
            if (args.length > index)
            {
                String s1 = CommandBase.getChatComponentFromNthArg(sender, args, index).getUnformattedText();
    ...
    protected void setTeamOption(ICommandSender sender, String[] args, int index) throws CommandException
    {
        ...
        if (scoreplayerteam != null)
        {
            ...
            else if (args.length == 4)
            {
                ...
                {
                    throw new WrongUsageException("commands.scoreboard.teams.option.noValue", s, CommandBase.joinNiceStringFromCollection(EnumChatFormatting.getValidValues(true, false)));
                }
                else if (!s.equalsIgnoreCase("friendlyfire") && !s.equalsIgnoreCase("seeFriendlyInvisibles"))
                {
                    ...
                    {
                        throw new WrongUsageException("commands.scoreboard.teams.option.noValue", s, CommandBase.joinNiceString(Team.EnumVisible.func_178825_a()));
                    }
                }
                else
                {
            ...
            else
            {
                ...
                CommandBase.notifyOperators(sender, this, "commands.scoreboard.teams.option.success", s, scoreplayerteam.getRegisteredName(), s1);
            }
        }
    }
    ...
    protected void joinTeam(ICommandSender p_147190_1_, String[] p_147190_2_, int p_147190_3_) throws CommandException
    {
        ...
        {
            String s4 = CommandBase.getCommandSenderAsPlayer(p_147190_1_).getName();
        ...
        else
        {
            while (p_147190_3_ < p_147190_2_.length)
            {
                ...
                if (s1.startsWith("@"))
                {
                    for (Entity entity : CommandBase.func_175763_c(p_147190_1_, s1))
                    {
                        String s3 = CommandBase.getEntityName(p_147190_1_, entity.getUniqueID().toString());
                ...
                {
                    String s2 = CommandBase.getEntityName(p_147190_1_, s1);
        ...
        if (!set.isEmpty())
        {
            ...
            CommandBase.notifyOperators(p_147190_1_, this, "commands.scoreboard.teams.join.success", Integer.valueOf(set.size()), s, CommandBase.joinNiceString(set.toArray(new String[set.size()])));
        }

        if (!set1.isEmpty())
        {
            throw new CommandException("commands.scoreboard.teams.join.failure", Integer.valueOf(set1.size()), s, CommandBase.joinNiceString(set1.toArray(new String[set1.size()])));
        }
    }
    ...
    protected void leaveTeam(ICommandSender p_147199_1_, String[] p_147199_2_, int p_147199_3_) throws CommandException
    {
        ...
        {
            String s3 = CommandBase.getCommandSenderAsPlayer(p_147199_1_).getName();
        ...
        else
        {
            while (p_147199_3_ < p_147199_2_.length)
            {
                ...
                if (s.startsWith("@"))
                {
                    for (Entity entity : CommandBase.func_175763_c(p_147199_1_, s))
                    {
                        String s2 = CommandBase.getEntityName(p_147199_1_, entity.getUniqueID().toString());
                ...
                {
                    String s1 = CommandBase.getEntityName(p_147199_1_, s);
        ...
        if (!set.isEmpty())
        {
            ...
            CommandBase.notifyOperators(p_147199_1_, this, "commands.scoreboard.teams.leave.success", Integer.valueOf(set.size()), CommandBase.joinNiceString(set.toArray(new String[set.size()])));
        }

        if (!set1.isEmpty())
        {
            throw new CommandException("commands.scoreboard.teams.leave.failure", Integer.valueOf(set1.size()), CommandBase.joinNiceString(set1.toArray(new String[set1.size()])));
        }
    }
    ...
    protected void emptyTeam(ICommandSender p_147188_1_, String[] p_147188_2_, int p_147188_3_) throws CommandException
    {
        ...
        if (scoreplayerteam != null)
        {
            ...
            else
            {
                ...
                CommandBase.notifyOperators(p_147188_1_, this, "commands.scoreboard.teams.empty.success", Integer.valueOf(collection.size()), scoreplayerteam.getRegisteredName());
            }
        }
    }
    ...
    protected void listPlayers(ICommandSender p_147195_1_, String[] p_147195_2_, int p_147195_3_) throws CommandException
    {
        ...
        {
            String s = CommandBase.getEntityName(p_147195_1_, p_147195_2_[p_147195_3_]);
    ...
    protected void setPlayer(ICommandSender p_147197_1_, String[] p_147197_2_, int p_147197_3_) throws CommandException
    {
        ...
        int i = p_147197_3_;
        String s1 = CommandBase.getEntityName(p_147197_1_, p_147197_2_[p_147197_3_++]);
        ...
        else
        {
            ...
            int j = s.equalsIgnoreCase("set") ? CommandBase.parseInt(p_147197_2_[p_147197_3_++]) : CommandBase.parseInt(p_147197_2_[p_147197_3_++], 0);

            if (p_147197_2_.length > p_147197_3_)
            {
                Entity entity = CommandBase.func_175768_b(p_147197_1_, p_147197_2_[i]);

                try
                {
                    NBTTagCompound nbttagcompound = JsonToNBT.getTagFromJson(CommandBase.buildString(p_147197_2_, p_147197_3_));
            ...
            CommandBase.notifyOperators(p_147197_1_, this, "commands.scoreboard.players.set.success", scoreobjective.getName(), s1, Integer.valueOf(score.getScorePoints()));
        }
    }
    ...
    {
        Scoreboard scoreboard = getScoreboard();
        String s = CommandBase.getEntityName(p_147187_1_, p_147187_2_[p_147187_3_++]);
    ...
    {
        Scoreboard scoreboard = getScoreboard();
        String s = CommandBase.getPlayerName(p_175779_1_, p_175779_2_[p_175779_3_++]);
    ...
    {
        Scoreboard scoreboard = getScoreboard();
        String s = CommandBase.getEntityName(p_175781_1_, p_175781_2_[p_175781_3_++]);
        ...
        else
        {
            ...
            {
                int i = p_175781_2_[p_175781_3_].equals("*") ? Integer.MIN_VALUE : CommandBase.parseInt(p_175781_2_[p_175781_3_]);
                ++p_175781_3_;
                int j = p_175781_3_ < p_175781_2_.length && !p_175781_2_[p_175781_3_].equals("*") ? CommandBase.parseInt(p_175781_2_[p_175781_3_], i) : Integer.MAX_VALUE;
                Score score = scoreboard.getValueFromObjective(s, scoreobjective);

                if (score.getScorePoints() >= i && score.getScorePoints() <= j)
                {
                    CommandBase.notifyOperators(p_175781_1_, this, "commands.scoreboard.players.test.success", Integer.valueOf(score.getScorePoints()), Integer.valueOf(i), Integer.valueOf(j));
                }
                else
                {
    ...
    {
        Scoreboard scoreboard = getScoreboard();
        String s = CommandBase.getEntityName(p_175778_1_, p_175778_2_[p_175778_3_++]);
        ScoreObjective scoreobjective = getObjective(p_175778_2_[p_175778_3_++], true);
        String s1 = p_175778_2_[p_175778_3_++];
        String s2 = CommandBase.getEntityName(p_175778_1_, p_175778_2_[p_175778_3_++]);
        ...
        else
        {
            ...
            else
            {
                ...
                CommandBase.notifyOperators(p_175778_1_, this, "commands.scoreboard.players.operation.success");
            }
        }
    }
        ...
        else
        {
            if (args[0].equalsIgnoreCase("objectives"))
            {
                ...
                else if (args[1].equalsIgnoreCase("remove"))
                {
                    if (args.length == 3)
                    {
                        return CommandBase.getListOfStringsMatchingLastWord(args, func_147184_a(false));
                    }
                }
            ...
            else if (args[0].equalsIgnoreCase("players"))
            {
                ...
                if (!args[1].equalsIgnoreCase("set") && !args[1].equalsIgnoreCase("add") && !args[1].equalsIgnoreCase("remove") && !args[1].equalsIgnoreCase("reset"))
                {
                    if (args[1].equalsIgnoreCase("enable"))
                    {
                        ...
                        if (args.length == 4)
                        {
                            return CommandBase.getListOfStringsMatchingLastWord(args, func_175782_e());
                        }
                    }
                    else if (!args[1].equalsIgnoreCase("list") && !args[1].equalsIgnoreCase("test"))
                    {
                        if (args[1].equalsIgnoreCase("operation"))
                        {
                            if (args.length == 3)
                            {
                                return CommandBase.getListOfStringsMatchingLastWord(args, getScoreboard().getObjectiveNames());
                            }

                            if (args.length == 4)
                            {
                                return CommandBase.getListOfStringsMatchingLastWord(args, func_147184_a(true));
                            }
            ...
            else if (args[0].equalsIgnoreCase("teams"))
            {
                ...
                if (args[1].equalsIgnoreCase("join"))
                {
                    if (args.length == 3)
                    {
                        return CommandBase.getListOfStringsMatchingLastWord(args, getScoreboard().getTeamNames());
                    }
