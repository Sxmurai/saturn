        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        String s = CommandBase.getChatComponentFromNthArg(sender, args, 5).getUnformattedText();
                    ...
                    else
                    {
                        ...
                        CommandBase.notifyOperators(sender, this, "commands.testforblock.success", Integer.valueOf(blockpos.getX()), Integer.valueOf(blockpos.getY()), Integer.valueOf(blockpos.getZ()));
                    }
                }
            }
        }
