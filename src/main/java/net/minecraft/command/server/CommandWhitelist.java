    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException
    {
        ...
        else
        {
            ...
            if (args[0].equals("on"))
            {
                ...
                CommandBase.notifyOperators(sender, this, "commands.whitelist.enabled");
            }
            else if (args[0].equals("off"))
            {
                minecraftserver.getConfigurationManager().setWhiteListEnabled(false);
                CommandBase.notifyOperators(sender, this, "commands.whitelist.disabled");
            }
            ...
            else if (args[0].equals("reload"))
            {
                ...
                CommandBase.notifyOperators(sender, this, "commands.whitelist.reloaded");
            }
        }
    }
