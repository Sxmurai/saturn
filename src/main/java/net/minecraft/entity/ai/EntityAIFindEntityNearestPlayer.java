...
public class EntityAIFindEntityNearestPlayer extends EntityAIBase
{
    ...
    public EntityAIFindEntityNearestPlayer(EntityLiving p_i45882_1_)
    {
        ...
        field_179435_c = new Predicate<Entity>()
        {
            public boolean apply(Entity p_apply_1_)
            {
                ...
                else
                {
                    ...
                    return !((double) p_apply_1_.getDistanceToEntity(field_179434_b) > d0) && EntityAITarget.isSuitableTarget(field_179434_b, (EntityLivingBase) p_apply_1_, false, true);
                }
            }
        };
    ...
    {
        double d0 = func_179431_f();
        List<EntityPlayer> list = field_179434_b.worldObj.getEntitiesWithinAABB(EntityPlayer.class, field_179434_b.getEntityBoundingBox().expand(d0, 4.0D, d0), field_179435_c);
        Collections.sort(list, field_179432_d);
    ...
    {
        EntityLivingBase entitylivingbase = field_179434_b.getAttackTarget();
        ...
        {
            Team team = field_179434_b.getTeam();
    ...
    {
        IAttributeInstance iattributeinstance = field_179434_b.getEntityAttribute(SharedMonsterAttributes.followRange);
