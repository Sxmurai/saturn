...
public class InventoryPlayer implements IInventory
{
    ...
    private int getInventorySlotContainItemAndDamage(Item itemIn, int p_146024_2_)
    {
        for (int i = 0; i < mainInventory.length; ++i)
        {
            if (mainInventory[i] != null && mainInventory[i].getItem() == itemIn && mainInventory[i].getMetadata() == p_146024_2_)
            {
                return i;
            }
        }
    ...
    public void setCurrentItem(Item itemIn, int p_146030_2_, boolean p_146030_3_, boolean p_146030_4_)
    {
        ...
        else if (p_146030_4_ && itemIn != null)
        {
            ...
            {
                int k = getInventorySlotContainItemAndDamage(itemIn, p_146030_2_);
                int l;
                ...
                mainInventory[currentItem] = new ItemStack(itemIn, l, p_146030_2_);
            }
        }
    }
    ...
    public boolean hasItemStack(ItemStack itemStackIn)
    {
        for (int i = 0; i < armorInventory.length; ++i)
        {
            if (armorInventory[i] != null && armorInventory[i].isItemEqual(itemStackIn))
            {
                return true;
            }
        }
        ...
        for (int j = 0; j < mainInventory.length; ++j)
        {
            if (mainInventory[j] != null && mainInventory[j].isItemEqual(itemStackIn))
            {
                return true;
            }
        }
