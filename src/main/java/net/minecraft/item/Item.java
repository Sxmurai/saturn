...
public class Item
{
    ...
    public static void registerItems()
    {
        ...
        Item.registerItemBlock(Blocks.sand, (new ItemMultiTexture(Blocks.sand, Blocks.sand, new Function<ItemStack, String>()
        {
            public String apply(ItemStack p_apply_1_)
            {
        ...
        Item.registerItemBlock(Blocks.yellow_flower, (new ItemMultiTexture(Blocks.yellow_flower, Blocks.yellow_flower, new Function<ItemStack, String>()
        {
            public String apply(ItemStack p_apply_1_)
            {
        ...
        Item.registerItemBlock(Blocks.red_flower, (new ItemMultiTexture(Blocks.red_flower, Blocks.red_flower, new Function<ItemStack, String>()
        {
            public String apply(ItemStack p_apply_1_)
            {
        ...
        Item.registerItem(414, "rabbit_foot", (new Item()).setUnlocalizedName("rabbitFoot").setPotionEffect(PotionHelper.rabbitFootEffect).setCreativeTab(CreativeTabs.tabBrewing));
    ...
    {
        Item.registerItem(Block.getIdFromBlock(blockIn), Block.blockRegistry.getNameForObject(blockIn), itemIn);
