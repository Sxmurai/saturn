...
public class JsonToNBT
{
    ...
    public static NBTTagCompound getTagFromJson(String jsonString) throws NBTException
    {
        ...
        else if (JsonToNBT.func_150310_b(jsonString) != 1)
        {
    ...
    static JsonToNBT.Any func_150316_a(String p_150316_0_, String p_150316_1_) throws NBTException
    {
        ...
        if (p_150316_1_.startsWith("{"))
        {
            ...
            {
                s1 = JsonToNBT.func_150314_a(p_150316_1_, true);
        ...
        else if (p_150316_1_.startsWith("[") && !JsonToNBT.field_179273_b.matcher(p_150316_1_).matches())
        {
            ...
            {
                s = JsonToNBT.func_150314_a(p_150316_1_, false);
    ...
    static class Primitive extends JsonToNBT.Any
    {
        ...
        public NBTBase parse() throws NBTException
        {
            ...
            if (jsonValue.startsWith("[") && jsonValue.endsWith("]"))
            {
                ...
                String[] astring = Iterables.toArray(Primitive.SPLITTER.split(s), String.class);
