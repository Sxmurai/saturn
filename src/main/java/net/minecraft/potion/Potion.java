...
public class Potion
{
    ...
    public void performEffect(EntityLivingBase entityLivingBaseIn, int p_76394_2_)
    {
        ...
        else if (id == Potion.hunger.id && entityLivingBaseIn instanceof EntityPlayer)
        {
            ((EntityPlayer)entityLivingBaseIn).addExhaustion(0.025F * (float)(p_76394_2_ + 1));
        }
        else if (id == Potion.saturation.id && entityLivingBaseIn instanceof EntityPlayer)
        {
        ...
        else if ((id != Potion.heal.id || entityLivingBaseIn.isEntityUndead()) && (id != Potion.harm.id || !entityLivingBaseIn.isEntityUndead()))
        {
            if (id == Potion.harm.id && !entityLivingBaseIn.isEntityUndead() || id == Potion.heal.id && entityLivingBaseIn.isEntityUndead())
            {
    ...
    {
        if ((id != Potion.heal.id || entityLivingBaseIn.isEntityUndead()) && (id != Potion.harm.id || !entityLivingBaseIn.isEntityUndead()))
        {
            if (id == Potion.harm.id && !entityLivingBaseIn.isEntityUndead() || id == Potion.heal.id && entityLivingBaseIn.isEntityUndead())
            {
