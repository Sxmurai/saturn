...
public class ServerScoreboard extends Scoreboard
{
    ...
    public boolean addPlayerToTeam(String player, String newTeam)
    {
        if (super.addPlayerToTeam(player, newTeam))
        {
            ...
            scoreboardMCServer.getConfigurationManager().sendPacketToAllPlayers(new S3EPacketTeams(scoreplayerteam, Arrays.asList(player), 3));
            func_96551_b();
            return true;
        }
        else
    ...
    public void removePlayerFromTeam(String p_96512_1_, ScorePlayerTeam p_96512_2_)
    {
        ...
        scoreboardMCServer.getConfigurationManager().sendPacketToAllPlayers(new S3EPacketTeams(p_96512_2_, Arrays.asList(p_96512_1_), 4));
        func_96551_b();
    }
    ...
    public void func_96549_e(ScoreObjective p_96549_1_)
    {
        ...
        for (EntityPlayerMP entityplayermp : scoreboardMCServer.getConfigurationManager().func_181057_v())
        {
