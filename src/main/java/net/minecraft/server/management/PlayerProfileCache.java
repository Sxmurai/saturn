...
public class PlayerProfileCache
{
    ...
    public GameProfile getGameProfileForUsername(String username)
    {
        ...
        {
            GameProfile gameprofile1 = PlayerProfileCache.getGameProfile(mcServer, s);
    ...
    public void load()
    {
        ...
        try
        {
            ...
            List<PlayerProfileCache.ProfileEntry> list = gson.fromJson(bufferedreader, PlayerProfileCache.TYPE);
