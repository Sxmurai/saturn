...
public class BiomeGenJungle extends BiomeGenBase
{
    ...
    {
        return rand.nextInt(10) == 0 ? worldGeneratorBigTree : (rand.nextInt(2) == 0 ? new WorldGenShrub(BiomeGenJungle.field_181620_aE, BiomeGenJungle.field_181622_aG) : (!field_150614_aC && rand.nextInt(3) == 0 ? new WorldGenMegaJungle(false, 10, 20, BiomeGenJungle.field_181620_aE, BiomeGenJungle.field_181621_aF) : new WorldGenTrees(false, 4 + rand.nextInt(7), BiomeGenJungle.field_181620_aE, BiomeGenJungle.field_181621_aF, true)));
    }
