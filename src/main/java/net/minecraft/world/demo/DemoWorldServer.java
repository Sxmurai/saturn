...
public class DemoWorldServer extends WorldServer
{
    ...
    public static final WorldSettings demoWorldSettings = (new WorldSettings(DemoWorldServer.demoWorldSeed, WorldSettings.GameType.SURVIVAL, true, false, WorldType.DEFAULT)).enableBonusChest();
    ...
    public DemoWorldServer(MinecraftServer server, ISaveHandler saveHandlerIn, WorldInfo worldInfoIn, int dimensionId, Profiler profilerIn)
    {
        ...
        worldInfo.populateFromWorldSettings(DemoWorldServer.demoWorldSettings);
    }
}
