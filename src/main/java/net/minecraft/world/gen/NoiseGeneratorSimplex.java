...
public class NoiseGeneratorSimplex
{
    ...
    {
        double d3 = 0.5D * (NoiseGeneratorSimplex.field_151614_a - 1.0D);
        double d4 = (p_151605_1_ + p_151605_3_) * d3;
        int i = NoiseGeneratorSimplex.func_151607_a(p_151605_1_ + d4);
        int j = NoiseGeneratorSimplex.func_151607_a(p_151605_3_ + d4);
        double d5 = (3.0D - NoiseGeneratorSimplex.field_151614_a) / 6.0D;
        ...
        {
            d15 = d15 * d15;
            d0 = d15 * d15 * NoiseGeneratorSimplex.func_151604_a(NoiseGeneratorSimplex.field_151611_e[k1], d9, d10);
        }
        ...
        {
            d16 = d16 * d16;
            d1 = d16 * d16 * NoiseGeneratorSimplex.func_151604_a(NoiseGeneratorSimplex.field_151611_e[l1], d11, d12);
        }
        ...
        {
            d17 = d17 * d17;
            d2 = d17 * d17 * NoiseGeneratorSimplex.func_151604_a(NoiseGeneratorSimplex.field_151611_e[i2], d13, d14);
        }
    ...
    public void func_151606_a(double[] p_151606_1_, double p_151606_2_, double p_151606_4_, int p_151606_6_, int p_151606_7_, double p_151606_8_, double p_151606_10_, double p_151606_12_)
    {
        ...
        for (int j = 0; j < p_151606_7_; ++j)
        {
            ...
            for (int k = 0; k < p_151606_6_; ++k)
            {
                ...
                double d5 = (d1 + d0) * NoiseGeneratorSimplex.field_151609_g;
                int l = NoiseGeneratorSimplex.func_151607_a(d1 + d5);
                int i1 = NoiseGeneratorSimplex.func_151607_a(d0 + d5);
                double d6 = (double)(l + i1) * NoiseGeneratorSimplex.field_151615_h;
                ...
                double d11 = d9 - (double)j1 + NoiseGeneratorSimplex.field_151615_h;
                double d12 = d10 - (double)k1 + NoiseGeneratorSimplex.field_151615_h;
                double d13 = d9 - 1.0D + 2.0D * NoiseGeneratorSimplex.field_151615_h;
                double d14 = d10 - 1.0D + 2.0D * NoiseGeneratorSimplex.field_151615_h;
                int l1 = l & 255;
                int i2 = i1 & 255;
                ...
                {
                    d15 = d15 * d15;
                    d2 = d15 * d15 * NoiseGeneratorSimplex.func_151604_a(NoiseGeneratorSimplex.field_151611_e[j2], d9, d10);
                }
                ...
                {
                    d16 = d16 * d16;
                    d3 = d16 * d16 * NoiseGeneratorSimplex.func_151604_a(NoiseGeneratorSimplex.field_151611_e[k2], d11, d12);
                }
                ...
                {
                    d17 = d17 * d17;
                    d4 = d17 * d17 * NoiseGeneratorSimplex.func_151604_a(NoiseGeneratorSimplex.field_151611_e[l2], d13, d14);
                }
