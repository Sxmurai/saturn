...
public class ComponentScatteredFeaturePieces
{
    ...
    public static class DesertPyramid extends ComponentScatteredFeaturePieces.Feature
    {
        ...
        protected void writeStructureToNBT(NBTTagCompound tagCompound)
        {
            ...
            tagCompound.setBoolean("hasPlacedChest0", field_74940_h[0]);
            tagCompound.setBoolean("hasPlacedChest1", field_74940_h[1]);
            tagCompound.setBoolean("hasPlacedChest2", field_74940_h[2]);
            tagCompound.setBoolean("hasPlacedChest3", field_74940_h[3]);
        }

        protected void readStructureFromNBT(NBTTagCompound tagCompound)
        {
            super.readStructureFromNBT(tagCompound);
            field_74940_h[0] = tagCompound.getBoolean("hasPlacedChest0");
            field_74940_h[1] = tagCompound.getBoolean("hasPlacedChest1");
            field_74940_h[2] = tagCompound.getBoolean("hasPlacedChest2");
            field_74940_h[3] = tagCompound.getBoolean("hasPlacedChest3");
        }
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            ...
            for (Object enumfacing0 : EnumFacing.Plane.HORIZONTAL)
            {
                ...
                if (!field_74940_h[enumfacing.getHorizontalIndex()])
                {
                    int l1 = enumfacing.getFrontOffsetX() * 2;
                    int i2 = enumfacing.getFrontOffsetZ() * 2;
                    field_74940_h[enumfacing.getHorizontalIndex()] = generateChestContents(worldIn, structureBoundingBoxIn, randomIn, 10 + l1, -11, 10 + i2, WeightedRandomChestContent.func_177629_a(DesertPyramid.itemsToGenerateInTemple, Items.enchanted_book.getRandom(randomIn)), 2 + randomIn.nextInt(5));
                }
            }
    ...
    public static class JunglePyramid extends ComponentScatteredFeaturePieces.Feature
    {
        ...
        {
            super.writeStructureToNBT(tagCompound);
            tagCompound.setBoolean("placedMainChest", field_74947_h);
            tagCompound.setBoolean("placedHiddenChest", field_74948_i);
            tagCompound.setBoolean("placedTrap1", field_74945_j);
            tagCompound.setBoolean("placedTrap2", field_74946_k);
        }

        protected void readStructureFromNBT(NBTTagCompound tagCompound)
        {
            super.readStructureFromNBT(tagCompound);
            field_74947_h = tagCompound.getBoolean("placedMainChest");
            field_74948_i = tagCompound.getBoolean("placedHiddenChest");
            field_74945_j = tagCompound.getBoolean("placedTrap1");
            field_74946_k = tagCompound.getBoolean("placedTrap2");
        }
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            ...
            else
            {
                ...
                fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 0, -4, 0, scatteredFeatureSizeX - 1, 0, scatteredFeatureSizeZ - 1, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 2, 1, 2, 9, 2, 2, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 2, 1, 12, 9, 2, 12, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 2, 1, 3, 2, 2, 11, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 9, 1, 3, 9, 2, 11, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 1, 3, 1, 10, 6, 1, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 1, 3, 13, 10, 6, 13, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 1, 3, 2, 1, 6, 12, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 10, 3, 2, 10, 6, 12, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 2, 3, 2, 9, 3, 12, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 2, 6, 2, 9, 6, 12, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 3, 7, 3, 8, 7, 11, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 4, 8, 4, 7, 8, 10, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                ...
                {
                    fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 2, 4, i1, 2, 5, i1, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                    fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 4, 4, i1, 4, 5, i1, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                    fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 7, 4, i1, 7, 5, i1, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                    fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 9, 4, i1, 9, 5, i1, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                }

                fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 5, 6, 0, 6, 6, 0, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);

                for (int k1 = 0; k1 <= 11; k1 += 11)
                {
                    for (int j1 = 2; j1 <= 12; j1 += 2)
                    {
                        fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, k1, 4, j1, k1, 5, j1, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                    }

                    fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, k1, 6, 5, k1, 6, 5, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                    fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, k1, 6, 9, k1, 6, 9, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                }

                fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 2, 7, 2, 2, 9, 2, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 9, 7, 2, 9, 9, 2, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 2, 7, 12, 2, 9, 12, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 9, 7, 12, 9, 9, 12, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 4, 9, 4, 4, 9, 4, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 7, 9, 4, 7, 9, 4, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 4, 9, 10, 4, 9, 10, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 7, 9, 10, 7, 9, 10, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 5, 9, 7, 6, 9, 7, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                ...
                fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 4, 1, 9, 4, 1, 9, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 7, 1, 9, 7, 1, 9, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 4, 1, 10, 7, 2, 10, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 5, 4, 5, 6, 4, 5, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                ...
                {
                    fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 1, -3, i2, 1, -2, i2, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                }

                for (int j2 = 2; j2 <= 12; j2 += 2)
                {
                    fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 1, -1, j2, 3, -1, j2, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                }

                fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 2, -2, 1, 5, -2, 1, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 7, -2, 1, 9, -2, 1, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 6, -3, 1, 6, -3, 1, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 6, -1, 1, 6, -1, 1, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                setBlockState(worldIn, Blocks.tripwire_hook.getStateFromMeta(getMetadataWithOffset(Blocks.tripwire_hook, EnumFacing.EAST.getHorizontalIndex())).withProperty(BlockTripWireHook.ATTACHED, Boolean.valueOf(true)), 1, -3, 8, structureBoundingBoxIn);
                setBlockState(worldIn, Blocks.tripwire_hook.getStateFromMeta(getMetadataWithOffset(Blocks.tripwire_hook, EnumFacing.WEST.getHorizontalIndex())).withProperty(BlockTripWireHook.ATTACHED, Boolean.valueOf(true)), 4, -3, 8, structureBoundingBoxIn);
                ...
                if (!field_74945_j)
                {
                    field_74945_j = generateDispenserContents(worldIn, structureBoundingBoxIn, randomIn, 3, -2, 1, EnumFacing.NORTH.getIndex(), JunglePyramid.field_175815_j, 2);
                }

                setBlockState(worldIn, Blocks.vine.getStateFromMeta(15), 3, -2, 2, structureBoundingBoxIn);
                setBlockState(worldIn, Blocks.tripwire_hook.getStateFromMeta(getMetadataWithOffset(Blocks.tripwire_hook, EnumFacing.NORTH.getHorizontalIndex())).withProperty(BlockTripWireHook.ATTACHED, Boolean.valueOf(true)), 7, -3, 1, structureBoundingBoxIn);
                setBlockState(worldIn, Blocks.tripwire_hook.getStateFromMeta(getMetadataWithOffset(Blocks.tripwire_hook, EnumFacing.SOUTH.getHorizontalIndex())).withProperty(BlockTripWireHook.ATTACHED, Boolean.valueOf(true)), 7, -3, 5, structureBoundingBoxIn);
                ...
                if (!field_74946_k)
                {
                    field_74946_k = generateDispenserContents(worldIn, structureBoundingBoxIn, randomIn, 9, -2, 3, EnumFacing.WEST.getIndex(), JunglePyramid.field_175815_j, 2);
                }
                ...
                if (!field_74947_h)
                {
                    field_74947_h = generateChestContents(worldIn, structureBoundingBoxIn, randomIn, 8, -3, 3, WeightedRandomChestContent.func_177629_a(JunglePyramid.field_175816_i, Items.enchanted_book.getRandom(randomIn)), 2 + randomIn.nextInt(5));
                }
                ...
                fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 9, -1, 1, 9, -1, 5, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                ...
                fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 8, -3, 8, 8, -3, 10, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 10, -3, 8, 10, -3, 10, false, randomIn, JunglePyramid.junglePyramidsRandomScatteredStones);
                ...
                if (!field_74948_i)
                {
                    field_74948_i = generateChestContents(worldIn, structureBoundingBoxIn, randomIn, 9, -3, 10, WeightedRandomChestContent.func_177629_a(JunglePyramid.field_175816_i, Items.enchanted_book.getRandom(randomIn)), 2 + randomIn.nextInt(5));
                }
