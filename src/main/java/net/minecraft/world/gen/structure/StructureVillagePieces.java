...
public class StructureVillagePieces
{
            ...
            while (j < 5)
            {
                ...
                for (StructureVillagePieces.PieceWeight structurevillagepieces$pieceweight : start.structureVillageWeightedPieceList)
                {
                    ...
                    if (k < 0)
                    {
                        ...
                        StructureVillagePieces.Village structurevillagepieces$village = StructureVillagePieces.func_176065_a(start, structurevillagepieces$pieceweight, p_176067_1_, rand, p_176067_3_, p_176067_4_, p_176067_5_, facing, p_176067_7_);
    ...
    private static StructureComponent func_176066_d(StructureVillagePieces.Start start, List<StructureComponent> p_176066_1_, Random rand, int p_176066_3_, int p_176066_4_, int p_176066_5_, EnumFacing facing, int p_176066_7_)
    {
        ...
        {
            StructureComponent structurecomponent = StructureVillagePieces.func_176067_c(start, p_176066_1_, rand, p_176066_3_, p_176066_4_, p_176066_5_, facing, p_176066_7_ + 1);
    ...
    public static class House2 extends StructureVillagePieces.Village
    {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            ...
            {
                hasMadeChest = true;
                generateChestContents(worldIn, structureBoundingBoxIn, randomIn, 5, 1, 5, House2.villageBlacksmithChestContents, 3 + randomIn.nextInt(6));
            }
